...
// Keep the component defined directly in this file (no star/barrel imports)
// and export ONLY the Retool-connected default at the bottom.

const PromptLockAnalyzeV2: FC = () => {
    ...
    fetch('https://promptshield-g1cz.onrender.com/v1/analyze', {
      ...
      .then(async (res) => {
        if (!res.ok) {
          ...
          if ((errData as any)?.detail) throw new Error((errData as any).detail)
...
// Give it a friendly name in the editor EXACTLY as you want it listed
;(PromptLockAnalyzeV2 as any).displayName = 'Prompt Lock Analyze'

// IMPORTANT: wrap with Retool connector and export as default ONLY
export default Retool.connectReactComponent(PromptLockAnalyzeV2)
